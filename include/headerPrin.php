...
<head>
    ...
    <link href="img/logo_verd.jpg" rel="icon" type="image/png">
		...
		<nav class="navbar navbar-expand-lg ">			  
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    ...
			    <ul class="navbar-nav mr-auto" aling="left">
					  ...
					  <!--boton de inicio-->
					  <a href="catalogos/slider/SliderP.php" ><button type="button" class="btn btn-white active" data-target="#" ></i>Slider</button><span class="sr-only">(current)</span></a>
					  <!--boton galeria-->
					  <a href="catalogos/galeria/GaleriaP.php"><button style="margin-left: 4px;" type="button" class="btn btn-white" data-toggle="modal" data-target="#" ><!--<i class="fas fa-home">--></i>Galeria</button></a>
					  <!--boton  superintendencia-->
					  <a href="catalogos/superintendencia/superintendenciaP.php" ><button style="margin-left: 4px;" type="button" class="btn btn-white" data-toggle="modal" data-target="#" ><!--<i class="fas fa-home">--></i>Superintendencia</button></a>
					  <a href="catalogos/instructores/index_instructores.php" ><button style="margin-left: 4px;" type="button" class="btn btn-white" data-toggle="modal" data-target="#" ><!--<i class="fas fa-home">--></i>Instructor</button></a>
			      <!--boton  cursos 2018-->
			      <div class="btn-group">   
				        ...
				        <div class="dropdown-menu ">    
					        ...
					        while ($sql = mysqli_fetch_array($result)) { ?>
					      	    ...
					      	    <a style="height: 15px;"class="dropdown-item" href="cursos/index_curso.php?id=<?php echo  $sql['id_mes']?>"><small><?php echo  $sql['nombre_mes']?></small></a> 
				  ...
				  <a style="margin-left: 30px;" class="navbar-brand" title="Cerrar Sesión" href="logout.php" data-content="Cerrar Sesión"><img src="img/logout.jpg" width="30" height="30" class="d-inline-block align-center"  alt=""></a>
