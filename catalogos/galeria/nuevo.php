...
<div class="container">
    <div class="jumbotron mt-3">
        <div class="row">
        <?php
        $sql = "select *from tarjetas where id_tarjeta=".$_GET['id'];
        ...
        <div class="col-md-6" style="margin-left: 25%;">
                <div class="card border-grey  text-center" align="text-center" style="width: 29rem; height: 33rem;"> 
                    <?php if($_GET['id'] != 0) { ?>
                    <img style="width: 20rem; height: 12rem; margin-left: 5rem; margin-top: 1rem;" class="card-img-top" src="../../<?php echo $fila['ruta_tarjeta']?>" alt="Card image cap">  
                    <?php } else{ ?>
